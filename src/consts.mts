...
export const allDefaultArmorPrototypes = await readFileAndGetStructs<ArmorPrototype>("ItemPrototypes/ArmorPrototypes.cfg");
export const allDefaultArtifactPrototypes = await readFileAndGetStructs<SpawnActorPrototype>(`/ArtifactPrototypes.cfg`);
export const allDefaultNightVisionGogglesPrototypes = await readFileAndGetStructs<ArmorPrototype>("ItemPrototypes/NightVisionGogglesPrototypes.cfg");
